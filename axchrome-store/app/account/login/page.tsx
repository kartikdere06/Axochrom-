...
export default function AccountLoginPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col justify-center px-6">
      <h1 className="text-2xl font-bold text-chrome-200">Sign in</h1>
      <p className="mt-2 text-sm text-chrome-500">Access your order history and saved details.</p>
      ...
      <p className="mt-6 text-sm text-chrome-500">
        New here?{" "}
        <Link href="/account/register" className="text-signal-500 hover:text-signal-400 focus-ring">
          Create an account
        </Link>
      </p>
    </div>
